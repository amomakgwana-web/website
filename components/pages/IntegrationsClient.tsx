...
const INTEGRATIONS: { name: string; category: Exclude<Category, "All">; letter: string; gradient: string; desc: string }[] = [
  { name: "Xero", category: "Accounting", letter: "X", gradient: "linear-gradient(135deg,#5533FF,#7B5FFF)", desc: "Sync invoices, bills and reconciliation data automatically." },
  { name: "Sage", category: "Enterprise", letter: "S", gradient: "linear-gradient(135deg,#0A7B3E,#00C87A)", desc: "Two-way sync with Sage's accounting and ERP suite." },
  { name: "QuickBooks", category: "Accounting", letter: "QB", gradient: "linear-gradient(135deg,#0A7B3E,#22D488)", desc: "Push transactions and reconciliation entries in real time." },
  { name: "Salesforce", category: "CRM", letter: "SF", gradient: "linear-gradient(135deg,#00C1D4,#5533FF)", desc: "Trigger payments and billing events straight from CRM records." },
  { name: "HubSpot", category: "CRM", letter: "H", gradient: "linear-gradient(135deg,#FF6B35,#FFA36B)", desc: "Keep customer billing status in sync with your pipeline." },
  { name: "SAP", category: "Enterprise", letter: "SAP", gradient: "linear-gradient(135deg,#3D22CC,#5533FF)", desc: "Enterprise-grade connectors for large-scale deployments." },
  { name: "Slack", category: "Communication", letter: "SL", gradient: "linear-gradient(135deg,#E8152A,#FF6B35)", desc: "Get payment, audit and billing alerts where your team works." },
  { name: "Microsoft Teams", category: "Communication", letter: "T", gradient: "linear-gradient(135deg,#5533FF,#4B39E0)", desc: "Route approval requests and notifications into Teams channels." },
  { name: "Zapier", category: "Automation", letter: "Z", gradient: "linear-gradient(135deg,#FF6B35,#FFB020)", desc: "Connect BIPRA to 5,000+ apps with no-code workflows." },
  { name: "Google Workspace", category: "Cloud Storage", letter: "G", gradient: "linear-gradient(135deg,#0A7B3E,#5533FF)", desc: "Export statements and reports straight to Drive and Sheets." },
  { name: "Power BI", category: "Analytics", letter: "P", gradient: "linear-gradient(135deg,#FF6B35,#E8152A)", desc: "Build live dashboards on top of your BIPRA transaction data." },
  { name: "Dropbox", category: "Cloud Storage", letter: "D", gradient: "linear-gradient(135deg,#5533FF,#00C1D4)", desc: "Archive audit trails and generated bills automatically." },
];
            ...
            <div className="integrations-grid">
              {filtered.map((i) => (
                <div key={i.name} className="gcard shine grid-pop tilt integrations-card">
                  ...
                  <div className="badge b-p" style={{ marginBottom: "10px", fontSize: "10px" }}>{i.category}</div>
