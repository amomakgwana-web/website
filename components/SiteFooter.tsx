      ...
      <footer>
        <div style={{maxWidth:"1200px",margin:"0 auto",padding:"64px 5% 0"}}>
          <div className="ft-grid">
            <div><Link className="logo" style={{marginBottom:"16px"}} href="/"><span className="logotext"><span style={{color:"#5533FF"}}>b</span><span style={{color:"#E8152A"}}>i</span><span style={{color:"#FF6B35"}}>p</span><span style={{color:"#0AC77E"}}>r</span><span style={{color:"#7B5FFF"}}>a</span></span></Link><p style={{fontSize:"13px",color:"rgba(255,255,255,0.35)",lineHeight:"1.75",maxWidth:"240px"}}>Payments, billing, and enterprise workflow automation for modern African businesses.</p></div>
            ...
            <div className="ft-col"><h4>Company</h4><ul><li><Link href="/about">About</Link></li><li><Link href="/solutions">Solutions</Link></li><li><Link href="/vas">VAS</Link></li><li><Link href="/developers">Developers</Link></li><li><Link href="/resources">Resources</Link></li><li><Link href="/pricing">Pricing</Link></li><li><Link href="/contact">Contact</Link></li></ul></div>
