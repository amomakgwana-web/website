      ...
      <footer>
        <div style={{maxWidth:"1200px",margin:"0 auto",padding:"64px 5% 0"}}>
          <div className="ft-grid">
            ...
            <div className="ft-col"><h4>Company</h4><ul><li><Link href="/about">About</Link></li><li><Link href="/solutions">Solutions</Link></li><li><Link href="/developers">Developers</Link></li><li><Link href="/resources">Resources</Link></li><li><Link href="/pricing">Pricing</Link></li><li><Link href="/contact">Contact</Link></li></ul></div>
