...
const PORTALS: { name: string; slug: string; logo: string; bg?: string }[] = [
  { name: "BipraPay Portal", slug: "biprapay", logo: "/biprapay-icon-mono.png", bg: "var(--rl)" },
  { name: "VeriBills Portal", slug: "veribills", logo: "/veribills-icon-mono.png", bg: "var(--vbl)" },
      ...
      {mobileOpen && (
        <div id="mobile-menu" style={{display:"block",position:"fixed",top:"var(--nav)",left:"0",right:"0",bottom:"0",zIndex:"190",background:"rgba(255,255,255,0.72)",backdropFilter:"blur(30px) saturate(1.6)",WebkitBackdropFilter:"blur(30px) saturate(1.6)",padding:"32px 6%",overflowY:"auto"}}>
          <div style={{display:"flex",flexDirection:"column",gap:"4px",marginBottom:"32px"}}>
            ...
            <Link style={{display:"flex",alignItems:"center",gap:"12px",padding:"12px",borderRadius:"10px",cursor:"pointer",transition:"background .15s"}} href="/biprapay" className="hv-px"><div style={{width:"32px",height:"32px",borderRadius:"8px",background:"var(--rl)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:"0"}}><img src="/biprapay-icon-mono.png" alt="" style={{width:"20px",height:"20px",objectFit:"contain"}} /></div><div><div style={{fontSize:"14px",fontWeight:"600",color:"var(--ink)"}}>BipraPay</div><div style={{fontSize:"12px",color:"var(--muted)"}}>Payments, audit &amp; instant gateway</div></div></Link>
            <Link style={{display:"flex",alignItems:"center",gap:"12px",padding:"12px",borderRadius:"10px",cursor:"pointer",transition:"background .15s"}} href="/veribills" className="hv-px"><div style={{width:"32px",height:"32px",borderRadius:"8px",background:"var(--vbl)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:"0"}}><img src="/veribills-icon-mono.png" alt="" style={{width:"20px",height:"20px",objectFit:"contain"}} /></div><div><div style={{fontSize:"14px",fontWeight:"600",color:"var(--ink)"}}>VeriBills</div><div style={{fontSize:"12px",color:"var(--muted)"}}>Billing &amp; audit engine</div></div></Link>
          ...
          <ul className="navlinks">
            ...
            <li className={`drop-wrap${drop === "products" ? " open" : ""}${isProductRoute ? " active" : ""}`} id="nav-products-wrap">
              ...
              <div className="dropdown">
                <Link className="drop-item" href="/biprapay"><div className="drop-icon" style={{background:"var(--rl)"}}><img src="/biprapay-icon-mono.png" alt="" style={{width:"20px",height:"20px",objectFit:"contain"}} /></div><div><div className="drop-name">BipraPay</div><div className="drop-desc">Payments, audit &amp; instant gateway</div></div></Link>
                <Link className="drop-item" href="/veribills"><div className="drop-icon" style={{background:"var(--vbl)"}}><img src="/veribills-icon-mono.png" alt="" style={{width:"20px",height:"20px",objectFit:"contain"}} /></div><div><div className="drop-name">VeriBills</div><div className="drop-desc">Bill presentment &amp; smart metering</div></div></Link>
