...
export default function Page() {
  return (
    ...
    <section className="section" style={{background:"var(--off)"}}><div className="inner"><p className="slabel">Use cases</p><h2 className="stitle">Built for every payment scenario</h2><p className="ssub">From one-off charges to millions of disbursements.</p>
    <div className="g3"><div className="card"><span className="badge b-r" style={{marginBottom:"12px"}}>Payroll</span><div style={{fontFamily:"var(--fd)",fontSize:"17px",fontWeight:"700",marginBottom:"8px"}}>Payroll disbursement</div><p style={{fontSize:"14px",color:"var(--muted)",lineHeight:"1.7"}}>Pay all employees in a single API call. EFT, real-time clearing, and mobile wallets.</p></div><div className="card"><span className="badge b-r" style={{marginBottom:"12px"}}>E-commerce</span><div style={{fontFamily:"var(--fd)",fontSize:"17px",fontWeight:"700",marginBottom:"8px"}}>E-commerce checkout</div><p style={{fontSize:"14px",color:"var(--muted)",lineHeight:"1.7"}}>Embed in any web or mobile checkout flow with pre-built UI or headless API.</p></div><div className="card"><span className="badge b-r" style={{marginBottom:"12px"}}>B2B</span><div style={{fontFamily:"var(--fd)",fontSize:"17px",fontWeight:"700",marginBottom:"8px"}}>Supplier payments</div><p style={{fontSize:"14px",color:"var(--muted)",lineHeight:"1.7"}}>Automate accounts payable — schedule, batch, and disburse invoices programmatically.</p></div><div className="card"><span className="badge b-r" style={{marginBottom:"12px"}}>Insurance</span><div style={{fontFamily:"var(--fd)",fontSize:"17px",fontWeight:"700",marginBottom:"8px"}}>Insurance payouts</div><p style={{fontSize:"14px",color:"var(--muted)",lineHeight:"1.7"}}>Trigger claims payments instantly upon approval. Days reduced to seconds.</p></div><div className="card"><span className="badge b-r" style={{marginBottom:"12px"}}>Commissions</span><div style={{fontFamily:"var(--fd)",fontSize:"17px",fontWeight:"700",marginBottom:"8px"}}>Commission payments</div><p style={{fontSize:"14px",color:"var(--muted)",lineHeight:"1.7"}}>Pay agents and contractors accurately on any schedule with a full audit trail.</p></div><div className="card"><span className="badge b-r" style={{marginBottom:"12px"}}>Government</span><div style={{fontFamily:"var(--fd)",fontSize:"17px",fontWeight:"700",marginBottom:"8px"}}>Government grants</div><p style={{fontSize:"14px",color:"var(--muted)",lineHeight:"1.7"}}>Mass disbursements to citizen beneficiaries with identity verification built in.</p></div></div>
    </div></section>
    ...
    <section className="section" style={{background:"var(--off)"}}><div className="inner">
      ...
      <div className="g3" style={{gap:"20px"}}>
        ...
        <div className="gcard shine grid-pop tilt" style={{borderRadius:"14px",padding:"24px"}}><div style={{fontSize:"15px",fontWeight:"700",color:"var(--ink)",marginBottom:"6px",display:"flex",alignItems:"center",gap:"8px"}}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>Commissions</div><p style={{fontSize:"13px",color:"var(--muted)",lineHeight:"1.65",marginBottom:"12px"}}>Agent and reseller commissions calculated and paid on configurable schedules.</p><div style={{fontSize:"12px",fontWeight:"600",color:"var(--r)"}}>Daily, weekly, or monthly</div></div>
