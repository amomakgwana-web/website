  ...
  return (
    ...
    <section className="section" style={{paddingTop:"100px"}}><div className="inner-n">
      ...
      <div style={{display:"flex",flexDirection:"column",gap:"32px"}}>
        ...
        <div><h2 style={{fontSize:"20px",fontWeight:"700",color:"var(--ink)",marginBottom:"12px"}}>4. Your rights (POPIA &amp; GDPR)</h2><p style={{fontSize:"15px",color:"var(--ink2)",lineHeight:"1.8"}}>You have the right to access, correct, or delete your personal information; object to or restrict processing; data portability; and to lodge a complaint with the Information Regulator of South Africa. Contact us at privacy@bipra.io to exercise these rights.</p></div>
        <div><h2 style={{fontSize:"20px",fontWeight:"700",color:"var(--ink)",marginBottom:"12px"}}>5. Contact</h2><p style={{fontSize:"15px",color:"var(--ink2)",lineHeight:"1.8"}}>BIPRA (Pty) Ltd, Sandton, Johannesburg, South Africa. Email: privacy@bipra.io | Phone: +27 11 000 0000</p></div>
      </div>
    </div></section></div>
  );
}
