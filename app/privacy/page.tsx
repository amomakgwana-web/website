  ...
  return (
    ...
    <section className="section" style={{paddingTop:"100px"}}><div className="inner-n">
      ...
      <div style={{display:"flex",flexDirection:"column",gap:"32px"}}>
        ...
        <div><h2 style={{fontSize:"20px",fontWeight:"700",color:"var(--ink)",marginBottom:"12px"}}>5. Contact</h2><p style={{fontSize:"15px",color:"var(--ink2)",lineHeight:"1.8"}}>BIPRA (Pty) Ltd, Sandton, Johannesburg, South Africa. Email: privacy@biprasoftware.com | Phone: +27 11 000 0000</p></div>
      </div>
    </div></section></div>
  );
}
