...
export default function Page() {
  return (
    ...
    <div>
      <div style={{display:"flex",alignItems:"center",gap:"10px",marginBottom:"20px"}}><div style={{width:"48px",height:"48px",borderRadius:"13px",background:"var(--pl)",display:"flex",alignItems:"center",justifyContent:"center"}}><img src="/morr-icon.png" alt="" style={{width:"28px",height:"28px",objectFit:"contain"}} /></div><span style={{fontFamily:"var(--fd)",fontWeight:"700",fontSize:"15px",color:"var(--p)"}}>Morr ERP</span></div>
